...
public class JsonpConvertingPlugin<T> implements MessageBodyReader<T>, MessageBodyWriter<T> {
    ...
    // hack to force dependency on Impl required by converter
    // otherwise have to explicitly add to system.xml
    private final Class<JsonProviderImpl> hack = JsonProviderImpl.class;
